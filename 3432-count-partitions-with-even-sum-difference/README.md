<h2><a href="https://leetcode.com/problems/count-integers-with-even-digit-sum/description/">3704. Count Partitions with Even Sum Difference</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code>.</p>
